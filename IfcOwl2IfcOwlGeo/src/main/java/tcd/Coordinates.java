...
/**
 *
 * @author https://www.programcreek.com/java-api-examples/index.php?source_dir=IPARCOS-master/app/src/main/java/farom/iparcos/catalog/Coordinates.java
 */
...
public class Coordinates { 
    ...
    static public double convertDe(String str) throws NumberFormatException{ 
        Pattern p = Pattern.compile("([\\+\\-]?)([0-9]{1,3})[°:\\s]([0-9]{1,3})([m:'\\s]([0-9]{1,3})([,\\.]([0-9]*))?[s\"]?)?[m:'\\s]?"); 
        Matcher m = p.matcher(str); 
